const mockProducts = [
  {
    ...
    description:
      "Ultra-light and powerful business laptop with a stunning display.",
    price: 1500.0,
    image:
  ...
  },
  {
    ...
    description:
      "Ergonomic aluminum laptop stand designed for better posture, improved airflow, and reduced neck strain during long working sessions.",
    price: 45.0,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl-0MnxTgX6ms0H5CXGxL4xTfydFa7R9sLxA&s",
  ...
  },
  {
    ...
    description:
      "Compact USB-C hub with HDMI, USB 3.0, SD card reader, and power delivery, expanding your laptop's connectivity options.",
    price: 35.0,
  ...
  },
  {
    ...
    description:
      "Premium over-ear headphones with industry-leading noise cancellation, exceptional sound quality, and comfortable design for long listening.",
    price: 250.0,
    image:
      "https://www.sony.com.mx/image/5d02da5df552836db894cead8a68f5f3?fmt=pjpeg&wid=330&bgcolor=FFFFFF&bgc=FFFFFF",
    category: "Audio",
    stock: 18,
  },
];
